//
// ASCOM.TLTinylibHttpCam01.Camera Local COM Server
//
...
namespace ASCOM.LocalServer
{
    public static class Server
    {
        ...
        private static string localServerAppId = "{a27b60e6-118b-4acf-afee-4a604d70a630}"; // Our AppId
        ...
        static void Main(string[] args)
        {
            ...
            TL = new TraceLogger("", "TLTinylibHttpCam01.LocalServer")
            {
            ...
            Thread.CurrentThread.Name = "TLTinylibHttpCam01 Local Server Thread";
        ...
        public static int IncrementObjectCount()
        {
            ...
            if(TL == null) 
                TL = new TraceLogger("", "TLTinylibHttpCam01.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
        ...
        private static void RegisterObjects()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error while registering the server:\n" + ex.ToString(), "ASCOM.TLTinylibHttpCam01.Camera", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
        ...
        private static void ElevateSelf(string argument)
        {
            ...
            {
                TL.LogMessage("IsAdministrator", $"The ASCOM.TLTinylibHttpCam01.Camera was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it."));
                MessageBox.Show("The ASCOM.TLTinylibHttpCam01.Camera was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it.", "ASCOM.TLTinylibHttpCam01.Camera", MessageBoxButtons.OK, MessageBoxIcon.Warning));
            }
            catch (Exception ex)
            {
                TL.LogMessageCrLf("IsAdministrator", $"Exception: {ex}");
                MessageBox.Show(ex.ToString(), "ASCOM.TLTinylibHttpCam01.Camera", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
        ...
        private static bool RegisterClassFactories()
        {
            ...
            foreach (Type driverType in driverTypes)
            {
                ...
                if (!factory.RegisterClassObject())
                {
                    ...
                    MessageBox.Show("Failed to register class factory for " + driverType.Name, "ASCOM.TLTinylibHttpCam01.Camera", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
            ...
            if (args.Length > 0)
            {
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        ...
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding", "ASCOM.TLTinylibHttpCam01.Camera", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
