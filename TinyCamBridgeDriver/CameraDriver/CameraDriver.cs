...
//
// ASCOM Camera driver for TLTinylibHttpCam01
//
...
namespace ASCOM.TLTinylibHttpCam01.Camera
{
    ...
    //
    // Your driver's DeviceID is ASCOM.TLTinylibHttpCam01.Camera
    //
    // The COM Guid attribute sets the CLSID for ASCOM.TLTinylibHttpCam01.Camera
    // The COM ClassInterface/None attribute prevents an empty interface called _TLTinylibHttpCam01 from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("7e120671-3b87-4653-baaf-70440c036670")]
    [ProgId("ASCOM.TLTinylibHttpCam01.Camera")]
    [ServedClassName("ASCOM Camera Driver for TLTinylibHttpCam01")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Camera : ReferenceCountedObjectBase, ICameraV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TLTinylibHttpCam01"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Camera()
        {
            try
